 ...
 */
public interface ControllerClusterManager extends LifecycleComponent<ControllerClusterManager> {
    /**
     ...
     *
     * @param channel the channel disconnected.
     */
    Completable unregister(final ControllerChannel channel);

    Single<Reply<?>> sendCommand(Command<?> command, final String targetId);
}
